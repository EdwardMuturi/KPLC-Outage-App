...
class OutageViewModel constructor(private val fetchOutagesUseCase: FetchOutagesUseCase) :
    KoinComponent {
    private val _outageInformationUiState: MutableStateFlow<OutageInformationUiState> =
        MutableStateFlow(OutageInformationUiState())
    val outageInformationUiState: StateFlow<OutageInformationUiState> get() = _outageInformationUiState
